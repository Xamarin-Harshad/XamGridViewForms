...
using XamGridView = XamGridViewForms.Controls.XamGridView;

[assembly: ExportRenderer(typeof(XamGridView), typeof(XamGridViewForms.Droid.XamGridViewRenderer))]
    ...
    public class XamGridViewRenderer : ViewRenderer<XamGridView, AGridView>
    {
		...
		protected override void OnConfigurationChanged(global::Android.Content.Res.Configuration newConfig)
        {
            ...
            if (newConfig.Orientation != _orientation)
                OnElementChanged(new ElementChangedEventArgs<XamGridViewForms.Controls.XamGridView>(this.Element, this.Element));
        }

        protected override void OnElementChanged(ElementChangedEventArgs<XamGridViewForms.Controls.XamGridView> e)
        {
